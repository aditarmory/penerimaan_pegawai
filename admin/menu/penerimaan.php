			...
			<div class="module">
				...
				<div class="module-body">
					<form class="form-horizontal row-fluid" action="" method="post">
						...
						<div class="control-group">
							<div class="controls">
								<button type="submit" name="submit" class="btn">Simpan</button> <a class='btn' href='?menu=penerimaan'>Batal</a> 
							</div>
						</div>
					</form>
				</div>
			...
			<div class="module">
				<div class="module-body">
					...
					<form class="form-horizontal row-fluid" action="" method="post">
						...
						<div class="control-group">
							<div class="controls">
								<button type="submit" name="submit" class="btn">Simpan</button> <?php echo "<a class='btn' href='?menu=penerimaan&kriteria=$id_lowongan'>Batal</a>"; ?>
							</div>
						</div>
					</form>
				</div>
